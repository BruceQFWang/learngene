...
from utils.cifar100_dataloader import get_permute_cifar100
...
def main():
    ...
    train_loader = get_permute_cifar100(args.num_works, args.batch_size, subtask_classes_num=5, num_imgs_per_cate=300, path=args.path)
    ...
    for task in range(args.num_works):
        ...
        #snapshot = './val_outputs/Val_lifelong_scratch_cifar/2021-12-14 00:04:52/task_{0}'.format(task)
        ...
        for epoch in range(best_epoch, args.epochs):
            ...
            train_loss, train_acc = train(train_loader[task](epoch), model, criterion, optimizer, epoch, args, snapshot=snapshot, name=train_name)
